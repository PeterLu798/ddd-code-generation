...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <modules>
    <#if _pomParamMap?exists && _pomParamMap["moduleList"]?exists>
      <#assign __moduleList = _pomParamMap["moduleList"] />
      <#list __moduleList as __moduleName>
        <module>${__moduleName}</module>
      </#list>
    </#if>
    </modules>
